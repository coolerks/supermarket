...
public class ProductCategoryController {
     ...
     * @return
     */
    @ApiOperation(value = "分类列表", notes = "商品分类列表,根据商品分类名模糊查询")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品分类添加失败", operation = "商品分类添加")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品分类更新失败", operation = "商品分类更新")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品分类删除失败", operation = "商品分类删除")
