...
public class SupplierController {
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品来源添加失败", operation = "商品来源添加")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品来源更新失败", operation = "商品来源更新")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品来源删除失败", operation = "商品来源删除")
