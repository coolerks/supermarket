...
public class ConsumerController {
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品去向添加失败", operation = "商品去向添加")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品去向更新失败", operation = "商品去向更新")
     ...
     * @return
     */
    @ControllerEndpoint(exceptionMessage = "商品去向删除失败", operation = "商品去向删除")
